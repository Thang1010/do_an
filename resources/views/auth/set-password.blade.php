...
<head>
    ...
    <title>Đặt mật khẩu - XM Coffee</title>
...
<div class="auth-container">
    ...
    <div class="auth-form-panel">
        ...
        <div class="w-full max-w-[380px]">
            ...
            <h1 style="font-family:'Playfair Display',serif;font-weight:700;font-size:32px;color:#F1F0EE;text-align:center;font-style:italic;margin-bottom:20px;">Đặt mật khẩu</h1>
            <p style="color:#7a6555;font-size:14px;text-align:center;margin-bottom:24px;font-family:'Outfit',sans-serif;">Vui lòng đặt mật khẩu mới để hoàn tất đăng nhập.</p>

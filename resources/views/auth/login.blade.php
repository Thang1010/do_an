...
<body>
    <div class="auth-container">
        ...
        <div class="auth-image-panel">
            <img src="{{ asset('images/login.png') }}" alt="XM Coffee - Cà phê thơm ngon" />
            <div class="auth-image-overlay"></div>
            <!-- Decorative quote -->
            <div class="absolute bottom-12 left-8 right-8 text-white">
                <p class="font-playfair text-2xl italic leading-relaxed opacity-90">"Một tách cà phê mỗi sáng,<br>làm
                    nên một ngày tuyệt vời."</p>
            ...
            <div class="w-full max-w-[380px]">
                ...
                <div class="auth-logo justify-center">
                    <img src="{{ asset('images/logo.png') }}" alt="XM Coffee Logo"
                        style="width: 330px; height: 150px; object-fit: contain;"
                        onerror="this.style.display='none'; this.parentElement.innerHTML='<span class=\'auth-logo-text\'>XM COFFEE</span>'">
                </div>
                ...
                <!-- Login Form -->
                <form id="login-form" method="POST" action="{{ route('auth.login.post') }}"
                    ...
                    <div class="auth-input-group">
                        <input id="login-email" type="text" name="login"
                            ...
                            placeholder="Email hoặc số điện thoại" value="{{ old('login') }}" autocomplete="username"
                            required />
                        @error('login')
                    ...
                    <div class="auth-input-group">
                        ...
                        <button type="button" class="auth-input-icon" onclick="togglePassword('login-password', this)"
                            aria-label="Hiện mật khẩu">
                            <svg id="eye-icon-login" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        <input type="checkbox" id="remember" name="remember" value="1"
                            class="w-4 h-4 accent-[#8D5D5D] cursor-pointer rounded" {{ old('remember') ? 'checked' : '' }}>
                        <label for="remember" class="text-[#C4B9A8] text-sm font-outfit cursor-pointer">Ghi nhớ đăng
                            nhập</label>
                    </div>
                ...
                <!-- Google Login -->
                <a class="auth-btn-google" href="{{ route('auth.google.redirect', ['intent' => 'login']) }}">

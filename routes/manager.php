...
Route::prefix('manager')->name('manager.')->middleware(['auth', 'role:quản lý,chủ cửa hàng'])->group(function () {
    ...
    Route::post('/orders/{id}/payment-qr',   [OrderController::class, 'generatePaymentQr'])->name('orders.payment-qr');
    ...
    Route::post('/inventory/import-excel',             [InventoryController::class, 'storeImportExcel'])->name('inventory.import.excel');

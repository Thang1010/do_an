...
<div class="page-header">
    ...
    <div class="page-actions">
        <button type="button" class="btn btn-secondary" onclick="openModal('shift-checkin-qr-modal')">Tạo QR chấm công</button>
...
<div class="card" style="margin-bottom: 16px;">
    <div class="card-header" style="display:flex; align-items:center; justify-content:space-between; gap:10px;">
        ...
        <a href="{{ route('manager.shifts.edit', ['id' => $shift->id, 'mode' => 'info']) }}" class="btn btn-warning btn-sm">Sửa thông tin ca</a>
    </div>
    <div class="modal-body" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 12px;">
        <div>
            <div class="text-12 text-muted">Ngày làm</div>
            <div class="font-600">{{ $shift->ngay_lam ? \Carbon\Carbon::parse($shift->ngay_lam)->format('d/m/Y') : '—' }}</div>
        </div>
        <div>
...
<div class="card">
    <div class="card-header" style="display:flex; align-items:center; justify-content:space-between; gap:10px;">
        ...
        <a href="{{ route('manager.shifts.edit', ['id' => $shift->id, 'mode' => 'staff']) }}" class="btn btn-warning btn-sm">Sửa nhân sự ca</a>
    </div>

...
<div class="auth-container">
    <div class="auth-image-panel">
        <img src="https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=800&q=80" alt="XM Coffee Barista"/>
        ...
        <div class="absolute top-12 left-8 right-8">
            <div class="flex items-center gap-3 mb-4">
                <div style="width:44px;height:44px;border-radius:50%;background:#2a1f14;border:2px solid #5a3e2b;display:flex;align-items:center;justify-content:center;">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo" style="width:32px;height:32px;object-fit:contain;" onerror="this.parentElement.innerHTML='XM'"/>
                </div>
        ...
        <div class="absolute bottom-12 left-8 right-8 text-white">
            <p class="font-playfair text-2xl italic leading-relaxed opacity-90">"Tài khoản mới sẽ được chủ cửa hàng xét duyệt."</p>
    ...
    <div class="auth-form-panel">
        ...
        <div class="w-full max-w-[440px] py-8">
            <div class="auth-logo justify-center">
                <div class="auth-logo-circle">
                    <img src="{{ asset('images/logo.png') }}" alt="XM Coffee Logo" class="w-10 h-10 object-contain"
                         onerror="this.style.display='none'; this.parentElement.innerHTML='XM'"/>
                </div>
            ...
            <form id="register-form" method="POST" action="{{ route('auth.register.post') }}" onsubmit="handleSubmit()">
                @csrf
                ...
                <div class="auth-input-group">
                    <select name="vai_tro" class="auth-input @error('vai_tro') is-invalid @enderror" required>
                        ...
                        <option value="khách hàng" {{ old('vai_tro') === 'khách hàng' ? 'selected' : '' }}>Khách hàng</option>
                        <option value="nhân viên" {{ old('vai_tro') === 'nhân viên' ? 'selected' : '' }}>Nhân viên</option>
                ...
                <div class="auth-input-group">
                    <input type="password" name="password" id="register-password"
                           ...
                           placeholder="Mật khẩu" autocomplete="new-password" required>
                ...
                <p class="text-[#7a6555] text-xs font-outfit mb-4">
                    Khách hàng sẽ nhận mã xác minh qua email. Tài khoản nhân viên/quản lý cần được quản trị xác nhận.
                </p>
            ...
            <a href="{{ route('auth.google.redirect', ['intent' => 'register']) }}"
               class="auth-btn-google"
               id="google-register-btn"
               data-google-base="{{ route('auth.google.redirect') }}">

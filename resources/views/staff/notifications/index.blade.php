...
@section('breadcrumb', 'Quản lý / <strong>Thông báo</strong>')

@section('content')
<div class="page-header">
    <div>
        <h1 class="page-title">Danh sách thông báo</h1>
        <p class="page-subtitle">Theo dõi các cập nhật từ hệ thống</p>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('staff.notifications.open', $notification->id) }}" class="btn btn-primary btn-sm">
                            Mở thông báo
                        </a>
                    </td>
                </tr>

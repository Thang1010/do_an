...
<div class="page-header">
    ...
    <a href="{{ route('manager.salary.export', ['thang' => $thang, 'nam' => $nam]) }}" class="btn btn-success" style="background-color: #27AE60; border-color: #27AE60; color: white; display: flex; align-items: center; gap: 4px;">
            ...
            <tbody>
                @forelse($users as $row)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('manager.salary.show', ['id' => $row['id'], 'thang' => $thang, 'nam' => $nam]) }}" class="btn btn-sm btn-secondary">Chi tiết</a>
